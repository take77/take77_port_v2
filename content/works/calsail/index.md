...
description: "個人事業主向けのAI-OCR経費処理アプリ。企画・料金設計からFlutterアプリ・Webダッシュボード・バックエンドの実装、両ストアへの申請までを一人で担当し、着手から約5か月でiOS / Android / Web の3面をリリース"
date: 2026-02-01
serviceCategory:
  - "system-development"
  - "web-development"
...
企画・設計・実装・リリース・運用のすべてを一人で担当した個人開発プロダクト。2026年2月の着手から約5か月で、iOSアプリ・Androidアプリ・Webの3面をほぼ同時期に公開し、現在も継続して開発・運用している。

## 課題

- 確定申告前にレシートが溜まる原因は「山になったこと」ではなく、一件ずつ手入力するコストの高さにあると考えた。摩擦が大きいために記帳が習慣にならず、その結果として山が積み上がる
...
分業がないぶん、企画時の判断がそのまま実装・価格・ストア申請まで一貫している。
